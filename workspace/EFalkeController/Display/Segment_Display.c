...
*/
void writeDigit(struct display *display, uint8_t displayNumber, uint8_t digit, bool lightPoint) {
...
*/
void writeDoublePoint(struct display *display, bool lightDouble) {
